...
Nedan följer uppgifterna som resulterar i inlämningarna ovan.
  ...
  I denna uppgift ska vi arbeta med ljudförfattning. Mer specifikt så ska vi skapa en ljudhistoria. Tänk: radioteater eller podcasts med berättelser. Ditt uppdrag är alltså att först skriva en kort historia om någonting, precis vad som helst. Sedan skall du ljudsätta denna historia med bakgrundsljud och effekter. Om historian handlar om en dag i parken så kanske man hör grodor som kvackar, vatten som porlar, och vinden som blåser i träden. När någon går -- fotsteg, och när en bil åker -- motorn som rumblar o.s.v.
  \paragraph{}
  I den här uppgiften ska vi arbeta med \texttt{Garage Band}, som redan innehåller en mängd samplingar för musik och ljudeffekter, passande för t.ex. podcasts.
  ...
  \begin{enumerate}
    ...
    \item När du är klar: exportera din ljudberättelse som \texttt{.mp3} och som \texttt{.aif} (ett okomprimerat ljudformat).
    \item Använd \texttt{Audacity} och din exporterade \texttt{.aif}-fil för att även exportera din ljudberättelse i \texttt{.ogg}-format. Notera att du alltså \textbf{inte} ska lämna in \texttt{.aif}-filen, utan vi använde den bara för att kunna öppna en oförstörd (okomprimerad) version av berättelsen i \texttt{Audacity}.
  \end{enumerate}



  \exercise{Ljuddistribution -- HTML5 Audio}
  Vi ska nu prova på ett sätt att bädda in ljud i webbsidor. Detta genom att använda oss av \texttt{HTML5}-elementet \texttt{<audio>}.
