...
Nedan följer uppgifterna som resulterar i inlämningarna ovan.
  ...
  \begin{itemize}
    ...
    \item Trailern måste innehålla...
      \begin{itemize}
        ...
        \item text.
      \end{itemize}
    \item Det är \textbf{inte} tillåtet att använda \texttt{Project Themes/Movie Trailers} i \texttt{iMovie}.
  \end{itemize}
  ...
  Vi ska nu prova på ett sätt att bädda in video i webbsidor. Detta genom att använda oss av \texttt{HTML5}-elementet \texttt{<video>}. Vi ska alltså skapa en webbsida som ``bäddar in'' trailern vi skapade i föregående uppgift.
  ...
  \begin{itemize}
    ...
    \item Webbsidan ska gå i samma ``grafiska stil'' som trailern.
  \end{itemize}
