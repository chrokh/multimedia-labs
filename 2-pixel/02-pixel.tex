...
\exercise{Rita med hjälp av javascript och canvas}
  ...
  \begin{enumerate}
      ...
      \item Läs och försök förstå hur du ritar med javascript i en canvas på sida med exempelvis: \href{http://joshondesign.com/p/books/canvasdeepdive/chapter01.html#what_is_canvas} {What is canvas} eller \href{http://www.w3schools.com/html/html5_canvas.asp}{Canvas på w3schools }
